...
source /usr/bin/virtualenvwrapper.sh
    ...
    curl https://proxy.kaguya.ink/proxy/https://github.com/Kaguya233qwq/EasyNoneBot/releases/download/template/nb.zip -o nb.zip
    ...
    curl https://proxy.kaguya.ink/proxy/https://bootstrap.pypa.io/get-pip.py -o get-pip.py
    python get-pip.py
